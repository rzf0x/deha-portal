<div class="mx-3 mt-5">
    ...
    <div class="mb-md-3 d-flex md-2">
        ...
        <div class="">
            <h4 class="fw-bold text-dark">Selamat Datang, {{ explode(' ', auth()->user()->name)[0] }}</h4>
        </div>
    </div>
    <!-- Dashboard Grid -->
    <div class="row mt-3">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="card-title">Status SPP</h5>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    @endforelse
                    <a href="{{ route('santri.pengumuman') }}"
                        class="d-md-none mt-md-4 mt-3 w-100 btn btn-sm btn-dark">Lihat
                        Semua Pengumuman</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 mb-5 col-lg-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    @endforelse
                    <a href="{{ route('santri.kegiatan') }}" class="d-md-none btn-sm mt-md-4 mt-3 w-100 btn btn-dark">Lihat
                        Semua Kegiatan</a>
                </div>
            </div>
        </div>
