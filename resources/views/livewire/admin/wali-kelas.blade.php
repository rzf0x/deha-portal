            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        {{ $waliKelasId ? 'Edit Data Wali Kamar' : 'Tambah Data Wali Kamar' }}
                        <h5>
                            <button type="button" class="close rounded-pill" data-bs-dismiss="modal"
                                aria-label="Close">
                                <i data-feather="x"></i>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" id="no_whatsapp" class="form-control"
                        ...
                        <div class="mb-2">
                            <label for="foto" class="form-label">Foto Wali Kelas</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary ms-1" data-bs-dismiss="modal"
                        ...
                        <i class="bx bx-check d-block d-sm-none"></i>
                        <span class="d-none d-sm-block">
                            {{ $waliKelasId ? 'Edit Data' : 'Tambah Data' }}
                        </span>
                    </button>
                </div>
            </div>
                ...
                <tbody>
                    @forelse ($this->getData as $item)
                        <tr>
                            ...
                            {{-- <td>{{ $item->role }}</td> --}}
                            <td class="w-25">
                                <img class="w-50" src="{{ asset($item->foto) }}" alt="">
                            </td>
