                        ...
                        @forelse ($this->getData as $item)
                            <tr>
                                ...
                                <td style="width: 120px;">
                                    @if ($item->foto)
                                        <img src="{{ Storage::url('images/santri/' . basename($item->foto)) }}" class="img-fluid mx-auto"
            ...
            <div class="modal-content">
                <div class="modal-header {{ $santriEditId ? 'bg-warning' : 'bg-primary' }}">
                    <h5 class="modal-title {{ $santriEditId ? 'text-dark' : 'text-white' }}">
                        {{ $santriEditId ? 'Update Santri' : 'Create Santri' }}
                    </h5>
                ...
                <div class="modal-body">
                    <form wire:submit.prevent={{ $santriEditId ? 'editStore' : 'createStore' }} class="row">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="file" class="form-control" wire:model="santriForm.foto" id="foto" />
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="santriForm.nama" id="nama"
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="santriForm.nisn" id="nisn"
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="santriForm.nism" id="nism"
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="santriForm.nik" id="nik"
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="santriForm.jumlah_saudara_kandung"
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="santriForm.npsn" id="npsn"
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="santriForm.no_kip" id="no_kip"
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="santriForm.no_kk" id="no_kk"
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="santriForm.nama_kepala_keluarga"
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="santriForm.yang_membiayai_sekolah"
                                id="yang_membiayai_sekolah" placeholder="Bapak">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="waliSantriForm.tempat_lahir_ayah"
                                id="tempat_lahir_ayah" placeholder="DKI Jakarta">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="date" class="form-control" wire:model="waliSantriForm.tanggal_lahir_ayah"
                                id="tanggal_lahir_ayah" placeholder="DKI Jakarta">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <select class="form-select" wire:model.defer="waliSantriForm.pendidikan_terakhir_ayah">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="waliSantriForm.pekerjaan_ayah"
                                id="pekerjaan_ayah" placeholder="Programmer">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="waliSantriForm.penghasilan_ayah"
                                id="penghasilan_ayah" placeholder="1000000">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="waliSantriForm.no_telp_ayah"
                                id="no_telp_ayah" placeholder="+62888....">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="waliSantriForm.tempat_lahir_ibu"
                                id="tempat_lahir_ibu" placeholder="DKI Jakarta">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="date" class="form-control" wire:model="waliSantriForm.tanggal_lahir_ibu"
                                id="tanggal_lahir_ibu" placeholder="DKI Jakarta">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="waliSantriForm.penghasilan_ibu"
                                id="penghasilan_ibu" placeholder="1000000">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="waliSantriForm.no_telp_ibu"
                                id="no_telp_ibu" placeholder="+62888....">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control"
                                wire:model="waliSantriForm.status_kepemilikan_rumah" id="status_kepemilikan_rumah"
                                placeholder="Pribadi">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="waliSantriForm.rt" id="rt"
                                placeholder="">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" wire:model="waliSantriForm.rw" id="rw"
                                placeholder="">
