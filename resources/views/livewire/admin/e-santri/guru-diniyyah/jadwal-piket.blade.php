<section>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h5 class="card-title">Daftar Jadwal Piket</h5>
            <button wire:loading.attr='disabled' wire:target='create,store,edit,update,delete' wire:click="create"
                class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createOrUpdate">
                Tambah Jadwal Piket +
            </button>
        </div>
        <div class="row">
            <form wire:submit='$refresh' class="col-12 col-md-7 d-flex align-items-center mb-2 mb-md-0">
                <input type="text" placeholder="Santri" wire:model='searchSantri' class="form-control">
                <button type="submit" class="btn btn-primary">cari</button>
            </form>
            <div class="col-12 col-md-7 d-flex align-items-center mb-2 mb-md-0">
                        ...
                        <tr>
                            ...
                            <td>
                                <button wire:loading.attr='disabled' wire:target='create,store,edit,update,delete'
                                    wire:click="edit({{ $jadwal->id }})" class="btn btn-warning btn-sm"
                                    data-bs-toggle="modal" data-bs-target="#createOrUpdate">Edit</button>
                                <button wire:loading.attr='disabled' wire:target='create,store,edit,update,delete'
