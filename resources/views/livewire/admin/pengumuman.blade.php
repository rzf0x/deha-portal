<section>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <button wire:click='create' data-bs-toggle="modal" data-bs-target="#createOrUpdatePengumuman"
        ...
        <div class="card-body">
            <table class="table">
                ...
                <tbody>
                    @forelse ($this->listPengumuman() as $pengumuman)
                        <tr>
                            ...
                            <td>
                                <button wire:click='edit("{{ $pengumuman->id }}")' data-bs-toggle="modal"
                                    data-bs-target="#createOrUpdatePengumuman"
                                    class="btn btn-warning btn-sm">Edit</button>
                                <button wire:click='deletePengumuman("{{ $pengumuman->id }}")'
    ...
    <div class="modal fade" wire:ignore.self id="createOrUpdatePengumuman" tabindex="-1">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
