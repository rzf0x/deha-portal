        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        @forelse ($this->listAdmin as $item)
                            <tr>
    ...
    <div class="modal fade text-left" id="default" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header {{ $admin_id ? 'bg-warning' : 'bg-primary' }}">
                    <h5 class="modal-title {{ $admin_id ? 'text-dark' : 'text-white' }}">{{ $admin_id ? 'Edit Jenjang' : 'Tambah Jenjang' }}</h5>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group mt-4">
                            <label for="nama">Pilih Role Admin</label>
                            <select class="form-select" wire:model='roles_id'>
                                <option value="">-- Pilih Role Admin --</option>
                                @foreach ($this->listRoleAdmin as $item)
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary ms-1" data-bs-dismiss="modal"
                        ...
                        <span class="d-none d-sm-block">
                            {{ $admin_id ? 'Update Data' : 'Tambah Data' }}
                        </span>
                    </button>
                </div>
            </div>
