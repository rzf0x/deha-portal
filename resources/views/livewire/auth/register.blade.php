<div id="auth-left">
    ...
    <form wire:submit="register">
        <div class="form-group position-relative has-icon-left mb-4">
            <input type="text" wire:model.live.debounce.300ms="email" autofocus class="form-control form-control-xl"
                placeholder="Email">
        ...
        <div class="form-group position-relative has-icon-left mb-4">
            <input type="password" wire:model.live="password" class="form-control form-control-xl"
        ...
        <button type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-5"
            @if ($isSubmitActive && !$errors->any()) '' @else disabled @endif>
            Sign Up
        </button>
    </form>
    <div class="text-center mt-5 text-lg fs-4">
        <p class='text-gray-600'>Already have an account? <a wire:navigate href="{{ route('login') }}"
                class="font-bold">Log
                in</a>.</p>
    </div>
</div>
